...
# ─────────────────────────────────────────────────────────────
CATALOG = {
    "이 숫자 어디서 나왔어요?":       ("R1", "수치에 출처·기간·집계기준", "auto",
                                       "표 각주에 '출처 / 기간 / 집계 기준' 3종 고정 배치"),
    "결론이 뭐예요?":                 ("R2", "결론이 첫 화면에 있을 것", "auto",
                                       "첫 10줄 안에 결론 문장과 숫자 배치"),
    "대안은 없어요?":                 ("R3", "대안은 2개 이상", "auto",
                                       "채택안 + 검토했으나 버린 안 1개를 함께 제시"),
    "너무 길어요":                    ("R4", "분량 압축", "auto",
                                       "문단당 300자 이하, 핵심 3개 이내로 정리"),
    "이거 누가 하는 거예요?":         ("R5", "담당자 명시", "manual",
                                       "실행 항목마다 담당 조직 또는 역할 표기"),
    "언제까지예요?":                  ("R6", "완료 시점 명시", "auto",
                                       "일정 표에 시작·종료일과 마일스톤 표기"),
    "비용은요?":                      ("R7", "비용 근거", "manual",
                                       "총액이 아니라 산출 근거와 단가를 함께 제시"),
    "리스크는요?":                    ("R8", "리스크와 대응", "manual",
                                       "리스크 2개 이상, 각각에 대응책 1줄"),
    "전에 했던 거랑 뭐가 달라요?":    ("R9", "선행 사례 대비 차이", "manual",
                                       "과거 시도와 이번 안의 차이를 표로 대조"),
    "다른 팀이랑 얘기됐어요?":        ("R10", "유관 조직 협의 상태", "manual",
                                       "협의 완료·진행중·미착수를 조직별로 표기"),
    "그래서 나한테 뭘 해달라는 거예요?": ("R11", "요청 사항 명시", "auto",
                                       "문서 첫머리에 '요청: ~' 한 줄을 둔다"),
    "이거 왜 지금이에요?":            ("R12", "시점 근거", "manual",
                                       "지금 해야 하는 이유를 외부 일정이나 데이터로 제시"),
}
